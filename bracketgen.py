...
def fill_winners(mens):
    ...
    if mens:
        ...
        MATCHUP_WINNERS[6] = "New Mexico"
        MATCHUP_WINNERS[7] = "Michigan St."
        MATCHUP_WINNERS[8] = "Florida"
        MATCHUP_WINNERS[9] = "Connecticut"
        MATCHUP_WINNERS[10] = "Colorado St."
        MATCHUP_WINNERS[11] = "Maryland"
        ...
        MATCHUP_WINNERS[18] = "Oregon"
        MATCHUP_WINNERS[19] = "Arizona"
        MATCHUP_WINNERS[20] = "BYU"
        MATCHUP_WINNERS[21] = "Wisconsin"
        MATCHUP_WINNERS[22] = "St. Mary's"
        ...
        MATCHUP_WINNERS[28] = "Illinois"
        MATCHUP_WINNERS[29] = "Kentucky"
        MATCHUP_WINNERS[30] = "UCLA"
        MATCHUP_WINNERS[31] = "Tennessee"
        #### start of second round ####
        MATCHUP_WINNERS[32] = "Auburn"
        MATCHUP_WINNERS[33] = "Michigan"
        MATCHUP_WINNERS[34] = "Mississippi"
        MATCHUP_WINNERS[35] = "Michigan St."
        MATCHUP_WINNERS[36] = "Florida"
        MATCHUP_WINNERS[37] = "Maryland"
        MATCHUP_WINNERS[38] = "Texas Tech"
        MATCHUP_WINNERS[39] = "Arkansas"
        MATCHUP_WINNERS[40] = "Duke"
        MATCHUP_WINNERS[41] = "Arizona"
        MATCHUP_WINNERS[42] = "BYU"
        MATCHUP_WINNERS[43] = "Alabama"
        MATCHUP_WINNERS[44] = "Houston"
        MATCHUP_WINNERS[45] = "Purdue"
        MATCHUP_WINNERS[46] = "Kentucky"
        MATCHUP_WINNERS[47] = "Tennessee"
        #### start of Sweet 16 ####
        MATCHUP_WINNERS[48] = "Auburn"
        MATCHUP_WINNERS[49] = "Michigan St."
        MATCHUP_WINNERS[50] = "Florida"
        MATCHUP_WINNERS[51] = "Texas Tech"
        MATCHUP_WINNERS[52] = "Duke"
        MATCHUP_WINNERS[53] = "Alabama"
        MATCHUP_WINNERS[54] = "Houston"
        MATCHUP_WINNERS[55] = "Tennessee"
        #### start of Elite 8 ####
        ...
        #### start of first round ####
        MATCHUP_WINNERS[0] = "UCLA"
        MATCHUP_WINNERS[1] = "Richmond"
        MATCHUP_WINNERS[2] = "Mississippi"
        MATCHUP_WINNERS[3] = "Baylor"
        MATCHUP_WINNERS[4] = "Florida St."
        MATCHUP_WINNERS[5] = "LSU"
        MATCHUP_WINNERS[6] = "Michigan St."
        MATCHUP_WINNERS[7] = "NC State"
        MATCHUP_WINNERS[8] = "USC"
        MATCHUP_WINNERS[9] = "Mississippi St."
        MATCHUP_WINNERS[10] = "Kansas St."
        MATCHUP_WINNERS[11] = "Kentucky"
        MATCHUP_WINNERS[12] = "Iowa"
        MATCHUP_WINNERS[13] = "Oklahoma"
        MATCHUP_WINNERS[14] = "South Dakota St."
        MATCHUP_WINNERS[15] = "Connecticut"
        MATCHUP_WINNERS[16] = "South Carolina"
        MATCHUP_WINNERS[17] = "Indiana"
        MATCHUP_WINNERS[18] = "Alabama"
        MATCHUP_WINNERS[19] = "Maryland"
        MATCHUP_WINNERS[20] = "West Virginia"
        MATCHUP_WINNERS[21] = "North Carolina"
        MATCHUP_WINNERS[22] = "Oregon"
        MATCHUP_WINNERS[23] = "Duke"
        MATCHUP_WINNERS[24] = "Texas"
        MATCHUP_WINNERS[25] = "Illinois"
        MATCHUP_WINNERS[26] = "Tennessee"
        MATCHUP_WINNERS[27] = "Ohio St."
        MATCHUP_WINNERS[28] = "Michigan"
        MATCHUP_WINNERS[29] = "Notre Dame"
        MATCHUP_WINNERS[30] = "Louisville"
        MATCHUP_WINNERS[31] = "TCU"
        #### start of second round ####
        MATCHUP_WINNERS[32] = "UCLA"
        MATCHUP_WINNERS[33] = "Mississippi"
        MATCHUP_WINNERS[34] = "LSU"
        MATCHUP_WINNERS[35] = "NC State"
        MATCHUP_WINNERS[36] = "USC"
        MATCHUP_WINNERS[37] = "Kansas St."
        MATCHUP_WINNERS[38] = "Oklahoma"
        MATCHUP_WINNERS[39] = "Connecticut"
        MATCHUP_WINNERS[40] = "South Carolina"
        MATCHUP_WINNERS[41] = "Maryland"
        MATCHUP_WINNERS[42] = "North Carolina"
        MATCHUP_WINNERS[43] = "Duke"
        MATCHUP_WINNERS[44] = "Texas"
        MATCHUP_WINNERS[45] = "Tennessee"
        MATCHUP_WINNERS[46] = "Notre Dame"
        MATCHUP_WINNERS[47] = "TCU"
        #### start of Sweet 16 ####
        MATCHUP_WINNERS[48] = "UCLA"
        MATCHUP_WINNERS[49] = "LSU"
        #MATCHUP_WINNERS[50] = "Stanford"
        #MATCHUP_WINNERS[51] = "Iowa"
        MATCHUP_WINNERS[52] = "South Carolina"
